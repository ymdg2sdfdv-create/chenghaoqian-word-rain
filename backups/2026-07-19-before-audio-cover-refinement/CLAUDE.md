...
🔄 Review 阶段
   +1/+2节点：1轮拼读 + 1轮中文提示回忆 + 3次快速识别
   +4/+7/+15节点：1轮中文提示回忆 + 2次快速识别
   每词完成后自动推进到下一个严格复习节点
   ↓ 全部复习完 → review-done.mp3 → new-words-start.mp3
🆕 New Words 阶段
   参数：3轮拼读 + 2轮中文提示回忆 + 6次快速识别
   快速识别：700→600→520→460→420→400ms
   每8词触发随机鼓励语音
   ↓ 全部新词完成 → complete.mp3
🎉 Complete（庆祝屏）
   统计：今日复习N词 + 新学M词
...
| 快速识别 | 6 | 3 | 2 |
| 中途鼓励 | 每8词 | 无 |
| 完整词音频 | 拼读揭示 + 提取揭示 + 快速识别开始时1次 | 揭示 + 快速识别开始时1次 | 揭示 + 快速识别开始时1次 |
...
| 快速识别开始时只朗读1次英文 | 爆炸阶段有清晰发音，同时避免高频闪现造成MP3叠音 |
